...
### Standard Trajectory Interpolator Parameters
...
### Local Trajectory Interpolator Parameters
...
local_trajectory_interpolator:
  ros__parameters:
    ...
    max_lin_speed: 0.8           # Maximum linear speed [m/s]
    max_ang_speed: 0.5           # Maximum angular speed [rad/s]
    
    # Artificial Potential Fields
    k_attractive: 1.0            # Attractive force gain
    k_repulsive: 0.9             # Repulsive force gain
    safety_distance: 1.5         # Minimum safe distance [m]
    obstacle_influence_range: 1.8 # Force influence radius [m]
    max_repulsive_force: 1.5     # Maximum repulsive force limit
    
    # Obstacle Avoidance Topics
    obstacle_cloud_map_topic: "/local_grid_obstacle"
    obstacle_cloud_body_topic: "/depth_camera/points"
    local_planner_enable_topic: "/local_planner_enable"
    collision_detected_topic: "/collision_detected"
```
